...
The foundation of our tools is here in 4 repos:
...
* UDDL (Universal Data Definition Language) - specification available [here](https://publications.opengroup.org/standards/face/c231)
...
* ~~[Data-Flow-Graphics](https://github.com/Epistimis/Data-Flow-Graphics) - This references FACE, the layer it depends on. A lot of work needs to be done here. If you're interested in graphics, this is the repo you want to work on.~~ This code has now been merged into the FACE repo as [com.epistimis.face.design](https://github.com/Epistimis/FACE/tree/master/com.epistimis.face.design). This provides [Sirius](https://www.eclipse.org/sirius/) graphics to display data flow models
...
* [UDDL](https://github.com/Epistimis/UDDL)  depends on [UDDL Query Language](https://github.com/Epistimis/UDDL-Query-Language)
* Currently, [FACE Template Language](https://github.com/Epistimis/com.epistimis.face.templ.parent) is not integrated. When integrated, it will depend on UDDL .
...
See the [Getting Started Guide](profile/GETTING-STARTED.md) for info on setting up an Eclipse development environment. It will take you all the way to a working demo.

# Contributing
See [Contributing](profile/CONTRIBUTING.md) for info on how to contribute. See [Code of Conduct](profile/CODE_OF_CONDUCT.md) for community standards.
...
There is a draft Data Modelling Guide available however it is too large for Github to display (hence no link). You can clone the .github repo and read it. It's in the profile subdirectory there.
